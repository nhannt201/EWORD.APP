     ...
     //   soundam.startAnimation(AnimationUtils.loadAnimation(Game1.this, R.layout.eff_move));
        soundam.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               if (coamthanh == "0") {
                   mn = MediaPlayer.create(Game1.this, R.raw.nengame);
                   mn.setVolume(40,40);
                   mn.start();
               coamthanh = "1";
     ...
     //   tientrinhagme.setMax(50);
       ...
       FILE_XULY file_xuly = new FILE_XULY(file_tv);
        try {
            ...
            dapan = xulidapan[1];
            txt_tv = findViewById(R.id.txt_TAGAME);
    ...
    private void ck_game() {
      //  hideKeyboard(Game1.this); //won't work
        if (txt_kq_input.getText().toString().trim().toLowerCase().contains(dapan.toLowerCase().trim())) {
            ...
            if (DIEM > toida_game) {
              ...
              //  tientrinhagme.setProgress(0);
                ...
                tientrinhagme.setProgress(DIEM);
                  tientrinhagme.startAnimation(AnimationUtils.loadAnimation(Game1.this, R.layout.eff_move_bt));
            ...
            tientrinhagme.setProgress(DIEM);
            play_eff(R.raw.sai);
            tientrinhagme.startAnimation(AnimationUtils.loadAnimation(Game1.this, R.layout.shake_3));
...
private void ms_thongbao(boolean debik) {
 ...
 if (debik == true) {
     ...
     dichvugame dichvugame = new dichvugame(Game1.this, 1);
     dichvugame.sendgame();
 } else {
     builder.setMessage(getString(R.string.youfail));
     dichvugame dichvugame = new dichvugame(Game1.this, 0);
     dichvugame.sendgame();
 }
// Set up the buttons
    ...
    public void onBackPressed() {
      ...
      //  Toast.makeText(Game1.this, "Đang về trang chủ"  , Toast.LENGTH_SHORT).show();
        ...
        Game1.this.overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
        finish();
    }
