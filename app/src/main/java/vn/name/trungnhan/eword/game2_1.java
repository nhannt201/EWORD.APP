...
public class game2_1 extends AppCompatActivity {
    ...
    private void ck_game(Button button) {
        if (button.getText().toString().trim().toLowerCase().contains(dapan.toLowerCase().trim())) {
            ...
            if (DIEM > toida_game) {
                ...
                tientrinhagme.startAnimation(AnimationUtils.loadAnimation(game2_1.this, R.layout.eff_move_bt));
                next_game();
            }
        } else {
    ...
    public void onBackPressed() {
        ...
        game2_1.this.overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
    ...
    private void ms_thongbao(boolean debik) {
        ...
        if (debik == true) {
            ...
            dichvugame dichvugame = new dichvugame(game2_1.this, 1);
            dichvugame.sendgame();
        } else {
            builder.setMessage(getString(R.string.youfail));
            dichvugame dichvugame = new dichvugame(game2_1.this, 0);
            dichvugame.sendgame();
        }
