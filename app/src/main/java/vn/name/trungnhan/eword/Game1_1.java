      ...
      //  this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        ...
        soundam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (coamthanh == "0") {
                    mn = MediaPlayer.create(Game1_1.this, R.raw.nengame);
                    mn.setVolume(40,40);
                    mn.start();
                    coamthanh = "1";
     ...
     //   tientrinhagme.setMax(50);
       ...
       txt1 = findViewById(R.id.txt_title_game);
        ...
        try {
            ...
            dapan = xulidapan[1];
            txt_tv = findViewById(R.id.txt_TAGAME_1);
            txt_tv.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    t1.speak(txt_tv.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
                }
            });
      ...
      //  hideKeyboard(Game1.this); //won't work
        if (txt_kq_input.getText().toString().trim().toLowerCase().contains(dapan.toLowerCase().trim())) {
            ...
            if (DIEM > toida_game) {
                ...
                hideKeyboard(Game1_1.this); //won't work
              ...
              //  tientrinhagme.setProgress(0);
                ...
                tientrinhagme.setProgress(DIEM);
                  tientrinhagme.startAnimation(AnimationUtils.loadAnimation(Game1_1.this, R.layout.eff_move_bt));
            ...
            tientrinhagme.setProgress(DIEM);
            play_eff(R.raw.sai);
            tientrinhagme.startAnimation(AnimationUtils.loadAnimation(Game1_1.this, R.layout.shake_3));
...
private void ms_thongbao(boolean debik) {
    ...
    if (debik == true) {
        ...
        dichvugame dichvugame = new dichvugame(Game1_1.this, 1);
        dichvugame.sendgame();
    } else {
        builder.setMessage(getString(R.string.youfail));
        dichvugame dichvugame = new dichvugame(Game1_1.this, 0);
        dichvugame.sendgame();
    }
...
// Set up the buttons
    ...
    public void onBackPressed() {
      ...
      //  Toast.makeText(Game1.this, "Đang về trang chủ"  , Toast.LENGTH_SHORT).show();
        ...
        Game1_1.this.overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
